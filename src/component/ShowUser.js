...
import { Link , useNavigate} from 'react-router-dom'
    ...
    function ShowUser() {
        ...
        useEffect(() => {
            ...
            let getdata = axios.get("https://manoj000001.github.io/json-spi/ducate.json/user")
...
//     navi('/ShowUser')
// })
axios.delete('https://manoj000001.github.io/json-spi/ducate.json/user/'+val).then(()=>{
    navi('/ShowUser')
})
